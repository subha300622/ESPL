...
<html>
    ...
    <script>
        ...
        function checkeHoliday() {
            ...
            if (xmlhttp !== null) {
                ...
                xmlhttp.open("GET", "/eTracker/getHoliday.jsp?fromDate=" + fromDate + "&toDate=" + toDate, false);
        ...
        function validate() {
            ...
            if (theForm.fromdate.type !== 'hidden') {
                if (form_date < today) {
                    alert('From Date cannot be less than Today');
                    document.theForm.fromdate.value = "";
                    theForm.fromdate.focus();
                    return false;
                }
            ...
            var Difference_In_Time = form_date1.getTime() - form_date.getTime();

            if (form_date1.getTime() < lastDate) {
                alert('To Date cannot be less than yesterday');
                document.theForm.todate.value = "";
                theForm.todate.focus();
                return false;
            }
    ...
    <script type="text/javascript">
        function call()
        {
            ...
            theForm.action = '/eTracker/UserProfile/leaveRequest.jsp?approvalStatus=' + x;
            theForm.submit();
        }
    </script>
...
<body>
    <%
        ...
        LinkedHashMap<String, String> leaveType = LeaveUtil.userLeaveTypes();
        Map<String, Float> leaveTypeDetails = LeaveUtil.leaveDetailsByUser(requestedby, branch);
        int editleaveId = 0;
        ...
        String valid = "valid";//LeaveUtil.checkMinimumWorkdays(requestedby);
                ...
                <table >
                    <tr>
                        <td>
                            ...
                            <a href="leaveRequest.jsp" style="font-weight: bold;"> Leave Request</a>&nbsp;&nbsp;&nbsp;&nbsp;
                            <%
                                if (noOfRequest > 0) {
                            %>
                            <a href="editLeaveRequest.jsp">Approve Leave</a>&nbsp;&nbsp;&nbsp;&nbsp;
                            <%                         }
                                if (requestedby == 104 || requestedby == 103) {%>
                            ...
                            <% }
                                if (requestedby == 112 || requestedby == 103 || requestedby == 104 || roleId == 4 || mail.equals("accounts@eminentlabs.net")) {%>
    ...
    %>
    <form name="theForm" action="createLeave.jsp" method="post" onsubmit="return validate(this);">
        <table bgcolor="E8EEF7"  style="width: 100%;">
            <tr>
                ...
                <td style="width: 15%;">
                    ...
                    <input type="text" id="fromdate" name="fromdate" maxlength="10" size="10" value="<%=editfrom%>" readonly  />
                    <%} else {%>
                ...
                <td style="width: 20%;">
                    <input type="text" id="todate" name="todate" value="<%=editto%>" maxlength="10" size="10" readonly  /></td>
            ...
            <tr>
                ...
                <td colspan="5">
                    <font size="2"
                          ...
                          name="description" id="description" wrap="physical" cols="60" rows="4" readonly
            ...
            <tr><td><input type="hidden" name="leaveid" value="<%=editleaveId%>"><input type="hidden" id="valid" name="valid" value="<%=valid%>"></td></tr>
    ...
    <form name="theForm" action="createLeave.jsp" method="post" onsubmit="return validate(this);">
        <table bgcolor="E8EEF7"  style="width: 100%;">
            ...
            </tr>            <tr><td><input type="hidden" name="leaveid" value="<%=editleaveId%>"><input type="hidden" id="valid" name="valid" value="<%=valid%>"></td></tr>
                    <%
                        }
                    } else {%>
            <table bgcolor="E8EEF7"  style="width: 100%;">
            ...
            <form name="theForm" action="createLeave.jsp" method="post" onsubmit="return validate(this)">
                <table bgcolor="E8EEF7"  style="width: 100%;">
                    <tr>
                        <td style="width: 14%;"><B>From</B></td>
                        <td style="width: 15%;"><input type="hidden" id="valid" name="valid" value="<%=valid%>"><input type="text" id="fromdate" name="fromdate" maxlength="10" size="10" value="<%=editfrom%>" readonly  /></td>
                        <td style="width: 2%;text-align: right;"><B>To</B></td>
                        <td style="width: 20%;"><input type="text" id="todate" name="todate" value="<%=editto%>" maxlength="10" size="10" readonly  /></td>
                        <td style="width: 4%;"><b>Type</b></td>
                        <td style="width: 46%;">
                            <select name="reason" id="reason">
                                <option value="--Select One--">--Select One--</option>
                    ...
                    <tr>
                        <td align="right" colspan="2"><input id="submit1" type="submit" value="Submit" /></td><td align="left"><input id="reset" type="reset" Value="Reset" /></td>
                    </tr>
                </table>
            </form>
            ...
            <table  style="width: 100%;">
                ...
                <%
                    ...
                    for (int i = 0; i < noOfLeave; i++) {
                        ...
                        String nodays = leaveDetails[i][13];
                ...
                <tr bgcolor="#E8EEF7" height="23">
                    <%                                     }
                    %>
                    <td><a href="leaveRequest.jsp?leaveid=<%=leaveId%>" title="<%=duration%>"><%=type%></a></td>
                    <td><%=from%></td>
                    <td><%=to%></td>
                    <td><%=createdOn%></td>
                    <td><%=nodays%></td>
                    ...
                    <% } else {
                        if (currDate.compareTo(toDate) <= 0) {%>
                    <td><a href="updateLeave.jsp?approval=-2&leaveid=<%=leaveId%>&type=<%=type%>">Cancel</a></td>
            ...
            <%} else {%>
            <center><b>Your not eligible to raise a leave request</b></center>
                <%}%>
            </body>
        ...
        $("#fromdate,#todate").datepicker("option", "showAnim", 'slide');
