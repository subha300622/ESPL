	...
	<TBODY height="100%">
		<TR>
			...
			<TABLE border=0 cellPadding=0 cellSpacing=0 width="100%" height="10%">
				<TBODY>
					<tr>
						<TD align=left>Global Customer Solutions Management</TD>
					</TR>
...
<TABLE bgColor=#E8EEF7 align="center">
	<TBODY>
		...
		<TR>
			...
			You have been Changed Your Password Successfully!!!... </FONT></B></TD>
		</tr>
		<tr align="center">
			<%  
			...
			session.invalidate();
		%>
			<td colspan="2"><input type="button" name="close" value="close"
