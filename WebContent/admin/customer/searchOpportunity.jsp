...
<table cellpadding="0" cellspacing="0" width="100%">
	<tr border="2" bgcolor="#E8EEF7">
		<td bgcolor="#E8EEF7" border="1" align="left"><font size="4"
			COLOR="#0000FF"> <b> Opportunity Administration </b></font><FONT SIZE="3"
...
<TABLE width="100%" border="0">
	<tr>
		...
		<%
			...
			{
%>
		<td>This list shows &nbsp;<%= "0"%>&nbsp;-<%=issuenoto%>&nbsp;of&nbsp;<%=rowcount%>&nbsp; <b>Opportunities</b> searched by you</td>
		<%
			}
			else
			{
%>
		<td>This list shows&nbsp;<%=issuenofrom%>&nbsp;-<%=issuenoto%>&nbsp;of&nbsp;<%=rowcount%>&nbsp; <b>Opportunities</b> searched by you</td>
		<%
			}
%>
	</tr>
