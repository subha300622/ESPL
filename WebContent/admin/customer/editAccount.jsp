...
<SCRIPT>
    ...
    function fun(theForm)
    {
        ...
        {
            alert('Please enter the valid billingstreet ');
...
<body>
    ...
    <FORM name=theForm onsubmit="return fun(this)"
          action="<%=request.getContextPath()%>/admin/customer/updateaccount.jsp"
            ...
            <TABLE width="100%" bgColor=#E8EEF7 border="0" align="center">
                <TBODY>
                    ...
                    <tr>
                        ...
                        <td width="25%">
                            <input type="text" name="duedate" id="duedate" value="<%=dueDate%>" maxlength="10" size="12" readonly /><a href="javascript:NewCal('duedate','ddmmyyyy')"> <img src="<%=request.getContextPath()%>/images/newhelp.gif" 	border="0" width="16" height="16" alt="Pick a date"></a>
                        </td>
                            ...
                            <SELECT NAME="industry" size="1">
                                <%
                                    for (int i = 0; i < industryExist.length; i++) {
                                        ...
                                        if (industry.equalsIgnoreCase(industryExist[i])) {
                                %>
                                <option value="<%= industryExist[i]%>" selected><%= industryExist[i]%></option>
                                <%
                                } else {
                                %>
                    ...
                    <tr height="21">
                        <td width="15%"></td>
                        <td width="70%" align="left" colspan=4><font size="2"
                                                                     face="Verdana, Arial, Helvetica, sans-serif"> <textarea
                                    rows="3" cols="58" name="comments" maxlength="4000"
                ...
                <div  style="width: 100%;" class="mid" id="MDAVpopupFiles">
                    <table id="contactTable" style="width: 100%;">
                        ...
                        <%List<MailCampaignDetails> mcclist = new ArrayList<MailCampaignDetails>();
                            int j = 0;
                            mcclist = mcc.allDetails(accountid, "Account");
                            if (mcclist.size() > 0) {
