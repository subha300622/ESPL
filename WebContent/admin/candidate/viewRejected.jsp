<%-- 
    Document   : viewRejected
    Created on : Apr 9, 2012, 7:54:04 PM
    Author     : Tamilvelan
--%>
...
<%
	...
	Logger logger = Logger.getLogger("viewRejected");
...
String filePath = request.getSession().getServletContext().getInitParameter("upload-resume");
        ...
        session.setAttribute("forwardpage", "/admin/candidate/viewRejected.jsp");
...
<table width="100%" align=center border="0">
	<tr>
		<td>
                    ...
                    <a href="viewRejected.jsp"><b>View Rejected Candidates</b></a>&nbsp;&nbsp;&nbsp;&nbsp;
...
%>
		...
		<%
			...
			{
%>
		<td>Displaying&nbsp;<%=issuenofrom%>&nbsp;- <%=issuenoto%>&nbsp;of&nbsp;<b><%=rowcount%></b> rejected candidates.</td>
		<%
			}
%>
	</tr>
...
%>
	<table align=right>
		<tr>
			<td>First</td>
			<td>Prev</td>
			<td><a href=viewRejected.jsp?manipulation=3>Next</a></td>
			<td><a href=viewRejected.jsp?manipulation=4>Last</a></td>
		</tr>
	</table>
	<%
			}
...
%>
	<table align=right>
		<tr>
			<td><a href=viewRejected.jsp?manipulation=1>First</a></td>
			<td><a href=viewRejected.jsp?manipulation=2>Prev</a></td>
			<td>Next</td>
			<td>Last</td>
		</tr>
	</table>
