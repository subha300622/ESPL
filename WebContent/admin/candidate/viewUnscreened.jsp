<%-- 
    Document   : viewUnscreened
    Created on : Apr 9, 2012, 7:54:25 PM
    Author     : Tamilvelan
--%>
...
<%
    ...
    Logger logger = Logger.getLogger("viewUnscreened");
...
<html>
    ...
    <script language="JavaScript">
        ...
        function setFocus() {
            ...
            if (document.searchCandidate.candidateName !== null) {
...
<body>
    ...
    <%
        ...
        session.setAttribute("forwardpage", "/admin/candidate/viewUnscreened.jsp");
    ...
    <table width="100%" align=center border="0" >
        <tr>
            <td>
                ...
                <a href="viewUnscreened.jsp"><b>View Unscreended Candidates</b></a> &nbsp;&nbsp;&nbsp;&nbsp;
                <a href="viewRejected.jsp">View Rejected Candidates</a> &nbsp;&nbsp;&nbsp;&nbsp;
                <a href="viewScreening.jsp">View Screening Candidates</a>   &nbsp;&nbsp;&nbsp;&nbsp;
                <a href="viewcandidate.jsp">View Shortlisted Candidates</a>
            </td>
        </tr>
    </table>
    ...
    <TABLE width="100%" border="0">
        <tr>
            ...
            %>
            <td>Displaying&nbsp;<%=issuenofrom%>&nbsp;- <%=issuenoto%>&nbsp;of&nbsp;<b><%=rowcount%></b> unscreened candidates.</td>
            <%
                }
            %>
        </tr>
    ...
    <table width=100%>
        ...
        <table align=right>
            <tr>
                <td>First</td>
                <td>Prev</td>
                <td><a href=viewUnscreened.jsp?manipulation=3>Next</a></td>
                <td><a href=viewUnscreened.jsp?manipulation=4>Last</a></td>
            </tr>
        </table>
        <%
        ...
        <table align=right>
            <tr>
                <td><a href=viewUnscreened.jsp?manipulation=1>First</a></td>
                <td><a href=viewUnscreened.jsp?manipulation=2>Prev</a></td>
                <td>Next</td>
                <td>Last</td>
            </tr>
        </table>
