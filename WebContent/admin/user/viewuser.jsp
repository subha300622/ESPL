...
<body>
    ...
    <table cellpadding="0" cellspacing="0" width="100%" bgColor="#C3D9FF">
        <tr border="2">
            ...
            <td border="1" align="right"><font size="4" COLOR="#0000FF"><b>Active
                        Sessions: <a href="<%=request.getContextPath()%>/admin/user/viewActiveUsers.jsp"><%=SessionCounter.getActiveUsers()%></a></b> </font><FONT SIZE="3"
    ...
    <%
        ...
        try {
            ...
            if (connection != null) {
                ...
                if (roleId == 1) {
                    sql = "SELECT DISTINCT USERID, FIRSTNAME,LASTNAME,COMPANY,EMAIL,MOBILE,PHONE,TEAM,VALUE,LASTLOGGEDON,(select count(issueid) from closedissue where COMMENTER=userid and COMMENTERTO=userid) as closedCount,substr(emp_id,0,1) as empid from users where roleid>1  order by empid,closedCount desc,value desc ";
                } else {
                ...
                if (request.getParameter("userregistration") != null) {
    %>

    <table width="100%" align=center border="0" bgcolor="E8EEF7">
        <tr>
            <td align=center><FONT SIZE="4" COLOR="#33CC33">New user
                    has been added successfully!: </FONT> <FONT SIZE="4" COLOR="#0000FF"><%= request.getParameter("email")%></FONT>
            </td>
        </tr>
    </table>
    <%
        ...
        <TABLE width="100%" border="0">
            ...
            <tr>
                <td>
                    ...
                    %>
                    <a href="<%=request.getContextPath()%>/admin/user/viewuser.jsp" style="font: bold;">View User</a>&nbsp;&nbsp;&nbsp;&nbsp;
                    <a href="<%=request.getContextPath()%>/timesheet/timeSheetAssigned.jsp">View Timesheet Status</a>&nbsp;&nbsp;&nbsp;&nbsp;
                ...
                <td colspan="6" align="right"><a
                        href="javascript:SetChecked(1,'approve')"><font
        ...
        <table width=100% id="user" class="tablesorter">
            ...
            <tbody> 
                ...
                <tr  height="9">
                    ...
                    <td width="23%" title="Reset Password"><font face="Verdana, Arial, Helvetica, sans-serif" size="1" color="#000000"><a href="javascript:;" class="resetPass" uName="<%= fname%>"  id="user<%= userId%>"><%= StringUtil.encodeHtmlTag(email)%></a></font></td>
    ...
    <div id="MDApopup" class="popup" style="position: fixed;">
        <h3 class="popupHeading">Reset Password</h3>
        <div>
            <hr />
            ...
            <div style="float: left;
                 margin-top: 5px;
                 margin-bottom: 5px;">
                <label style="width: 100px; margin: 0px; 
                       display: inline-block;">Reset Type</label>
            ...
            <div style="    clear: both;
                 margin-top: 5px;"></div>                  
            <div class="pwdtxt" style="display: none;    float: left;               
                 margin-top: 5px;
                 margin-bottom: 5px;">
                <label style="width: 100px; margin: 0px; 
                       display: inline-block;">Password</label>
                <input type="password" name="password" id="password" minlength=6 maxlength="15" >
            </div>
            <div style="    clear: both;
                 margin-top: 5px;"></div>                <div class="pwdtxt" style="display: none;     float: left;
                 margin-top: 5px;
                 margin-bottom: 5px;">
                <label style="width: 100px; margin: 0px; 
                       display: inline-block;">Confirm password</label>
                <input type="password" name="conpassword" id="conpassword" minlength=6 maxlength="15" >
            </div>
            <div style="    clear: both;
                 margin-top: 5px;"></div>                  
            <div style="    float: left;
