<%-- 
    Document   : eminentTimeSheet
    Created on : Nov 23, 2009, 8:13:58 PM
...
<%
	...
	ResultSet rs1=null,rs2=null,rs3=null;
        ...
        String learning         =   request.getParameter("learnings");
...
//        logger.info("Selected End Date"+selectedEndDate);
	 ...
	 String issueDetails[][]   =   IssueDetails.displayEminentIssues("Worked",start, end, projectId);
...
<table cellpadding="0" cellspacing="0" width="100%">
	<tr border="2" bgcolor="#E8EEF7">
		<td bgcolor="#E8EEF7" border="1" align="left"><font size="4"
			COLOR="#0000FF"> <b> Worked Issues for the Month of </b></font><FONT
...
%>
                    ...
                    <select name='chartType' id='chartType' >
                            ...
                            <%if (type.equalsIgnoreCase("Worked") ){%>
...
<table width="100%">
	<tr height="10">
            <td align="left" width="100%"><b><%=GetProjects.getProjectName(projectId).replace(":"," v")%></b> worked Issues in the month of <b><%=monthSelect.get(month)%> <%=year%></b> is listed below. Total worked issues are <b> <%=rowcount%>.
		</b></td>
