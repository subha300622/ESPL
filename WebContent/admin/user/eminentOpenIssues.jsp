<%-- 
    Document   : eminentOpenIssues
    Created on : 7 Jun, 2010, 11:35:36 AM
    Author     : ADAL
--%>
...
<%
	...
	Logger logger = Logger.getLogger("eminentOpenIssues");
...
<meta name="keywords" content="GST in SAP, SAP GST Accelerator, GST Success in SAP, GST India in SAP, GST SAP Success, GST Suvidha Provider, GST ASP GSP, GST, CGST,SGST, IGST, UGST,  SAP NW based Product Development, SAP Consulting, SAP Implementation, SAP Support Services, SAP Outsourcing, SAP Implementation India, SAP Implementation Bangalore, SAP Implementation Chennai, SAP Implementation Belgium, SAP Implementation Paris, SAP Implemtation Australia, SAP Implementation France, SAP Implementation Mumbai, SAP Implementation Kerala, SAP Implementation Belgaum, SAP Implementation Thailand, SAP Implementation Mexico, SAP Implementation America">
    ...
    function monthSelection(){
        ...
        if(selectedValue>=startRange &&selectedValue<=current_date ){
            ...
            alert("You can view Open Issues from Aug 2008 to Current Month");
        }
    }
</script>
...
//        logger.info("Selected End Date"+selectedEndDate);
        String issueDetails[][]   =   IssueDetails.displayOpenIssues(start, end, projectId);
...
<table cellpadding="0" cellspacing="0" width="100%">
	<tr border="2" bgcolor="#E8EEF7">
		<td bgcolor="#E8EEF7" border="1" align="left"><font size="4"
			COLOR="#0000FF"> <b> Open Issues for the Month of </b></font><FONT
...
<table width="100%">
	<tr height="10">
            <td align="left" width="100%"><b><%=GetProjects.getProjectName(projectId).replace(":"," v")%></b> Active issues in the month of <b><%=monthSelect.get(month)%> <%=year%></b> is listed below. Total active issues are <b> <%=rowcount%>.
		</b></td>
