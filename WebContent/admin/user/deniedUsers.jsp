...
<%
    ...
    Logger logger = Logger.getLogger("DeniedUsers");
...
<html>
    ...
    <body>
        ...
        <table cellpadding="0" cellspacing="0" bgcolor="C3D9FF" width="100%">
            <tr border="2">
                <td border="1" align="left" width="100%"><font size="4"
                                                               COLOR="#0000FF"><b>Access Denied Users</b> </font><FONT SIZE="3"
                    ...
                    <tr  height="9">
                        ...
                        <td width="5%" align="center"><font
                                face="Verdana, Arial, Helvetica, sans-serif" size="1" color="#000000"><input
                                    type="checkbox" name="approve" value="<%=userid%>"></font></td>
                    </tr>
                    <%
