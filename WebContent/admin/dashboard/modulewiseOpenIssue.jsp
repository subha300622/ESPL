<%-- 
    Document   : modulewiseOpenIssue
    Created on : Nov 21, 2012, 10:46:45 AM
    Author     : Tamilvelan
--%>
...
<%
    ...
    Logger logger = Logger.getLogger("modulewiseOpenIssue");
        ...
        <center>
            ...
            <table cellpadding="0" cellspacing="0" width="100%">
                <tr border="2" bgcolor="C3D9FF">
                    ...
                    <%
                        ...
                        session.setAttribute("forwardpage", "/admin/dashboard/modulewiseOpenIssue.jsp");
                        //int count =0;
                        try {
                            ...
                            if (connection != null) {
                                ...
                                if (request.getParameter("pid") != null) {
                                    ...
                                    project = request.getParameter("pid");
                                    mid = request.getParameter("mid");
                                    pj = request.getParameter("project");

                                    logger.info("Get Project" + project);
                                    logger.info("Get Module" + mid);
                                    ...
                                    if (project == null) {
                                        ...
                                        project = (String) session.getAttribute("moduleForProject");
                                        mid = (String) session.getAttribute("moduleidForOpenIssue");
                                        pj = (String) session.getAttribute("pj");

                                    }

                                    if (flag == false) {

                                        session.setAttribute("moduleForProject", project);
                                        session.setAttribute("moduleidForOpenIssue", mid);
                                        session.setAttribute("pj", pj);

                                    }

                                    logger.info("Project" + project);
                                    logger.info("Module" + mid);
                    ...
                    <td border="1" align="left" width="75%"><font size="4"
                                                                  COLOR="#0000FF"><b>Project&nbsp; :&nbsp; <%= pj%> </b></font><FONT
            ...
            <table width="100%" height="15">
                <tr>
                    <%                            if (rowcount == 0) {
                    %>
                    <jsp:forward page="modulewiseChart.jsp?project=<%=pj%>"/>
                ...
                <TABLE width="100%" id="searchTable" class="tablesorter">                        <thead>
                    ...
                    <tbody>
                        <%
                            ...
                            String pro = pj.substring(0, index);
                            String fix = pj.substring((index + 1));
                            if (rs != null) {
                        ...
                        <tr class="zebraline" height="28" style="padding: 5px;">
                            ...
                            <td class="background" ><font face="Verdana, Arial, Helvetica, sans-serif"
                                    ...
                                    %>
                            <td class="background" ><font face="Verdana, Arial, Helvetica, sans-serif" size="1" color="#000000"><%= modifiedOn%></font></td>
                            <td class="background" ><font face="Verdana, Arial, Helvetica, sans-serif" size="1" color="#000000"><%= status%></font></td>                       
