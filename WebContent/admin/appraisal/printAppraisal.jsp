...
<table align="center" width="100%" cellpadding="0" cellspacing="0">
	...
	<tr  bgcolor="#C3D9FF">
            <td align="left"><font size="4" COLOR="#0000FF"><b> Appraisal detail for <%=GetProjectManager.getUserName(appraisalUser)%> for period of <%=period %></b></font></td>
                <td>
...
<%
                    try
                    {
                            ...
                            <tr bgcolor="<%=color%>">
                                <td class="bordertable"><%=GetProjectManager.getUserName(appraisalComment.getCommentedBy())%></td>
                                <td class="bordertable"><%=commentedTime%></td>
                                <td class="bordertable"><%=appraisalComment.getComments()%></td>
                                <td class="bordertable"><%=AppraisalUtil.getAppraisalStatus(commentStatusId)%></td>
                                <td class="bordertable"><%=GetProjectManager.getUserName(appraisalComment.getCommentedTo())%></td>
