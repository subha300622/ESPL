 <%-- 
    ...
    Created on : 19 Oct, 2011, 12:44:07 PM
    Author     : Tamilvelan
--%>
...
<%
      ...
      if(spId!=null){
       session.setAttribute("uploadSpid",spId);
           }
...
<form name="form" action="uploadDetails.jsp" enctype="multipart/form-data" method="post" onSubmit="return validate();">
