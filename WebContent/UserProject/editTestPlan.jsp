<%-- 
    Document   : editTestPlan
    Created on : 9 Aug, 2011, 10:29:44 AM
    Author     : Tamilvelan
--%>
	...
	function createRequest()
	{
        ...
        function removeModules(){
            ...
            if(xmlhttp!=null){
                ...
                var module  =   "${pageContext.servletContext.contextPath}/admin/tqm/removeModules.jsp?planid="+planId;
  ...
  //          xmlhttp.onreadystatechange = callback;
	...
	function totalHours()
	{
        ...
        if(xmlhttp != null)
        {
            ...
            xmlhttp.open("GET","${pageContext.servletContext.contextPath}/admin/tqm/getTotalHours.jsp?startDate="+startDate+"&endDate="+endDate+"&rand="+Math.random(1,10), true);
            xmlhttp.onreadystatechange = callback;
            xmlhttp.send(null);
        }
	}
        ...
        function callManagers()
	{
        ...
        if(xmlhttp != null)
        {
            ...
            xmlhttp.open("GET","${pageContext.servletContext.contextPath}/admin/tqm/managerDetails.jsp?product="+prodId+"&rand="+Math.random(1,10), true);
	...
	function callModules()
	{
        ...
        if(xmlhttpMod != null)
        {
            ...
            xmlhttpMod.open("GET","${pageContext.servletContext.contextPath}/admin/tqm/moduleDetails.jsp?product="+prodId+"&rand="+Math.random(1,10), true);
    ...
    <body>
        <form name="executionpaln" onsubmit="return validate(this)" action="updateTestPlan.jsp" method="post">
            <table width="100%">
                <tr bgcolor="#C3D9FF">
            ...
            try{
                String planId   =   request.getParameter("planId");
                 ...
                 logger.info("Pid in edit test plan"+pId);
            ...
            <table width="60%" bgColor=#E8EEF7 border="0" align="center">
                <tr>
                    <td><b>Plan Name</b><input type="hidden" id="planId" name="planId" value="<%=planId%>"/><input type="hidden" id="pId" name="pId" value="<%=pId%>"/></td>
