        ...
        <div align="center">
            <center>
                ...
                <%
                    ...
                    if (no == null || no.equals("") || !pattern.matcher(no).matches()) {%>
                <table align="center" width="100%" bgcolor="C3D9FF">
                    <tr>
                        <td>Issue not available</td>
                    </tr>
                </table>
                <% } else {
                ...
                <br>
                <%
                    String pro = "", pmanager = "", dmanager = "", amanager = "";
                    ...
                    ResultSet rs = null, rs3 = null, result = null, result1 = null, rs4 = null, rs5 = null, rs6 = null, rs7 = null, rs_comments = null;
                    boolean flag = true;
                    String phase = null;
                    ...
                    try {
                        ...
                        rs = stmt.executeQuery("SELECT CUSTOMER,PNAME AS PROJECT,PLATFORM,MODULE,found_version,SEVERITY,PRIORITY,TYPE,VERSION AS FIX_VERSION, due_date,rating,feedback,ESCALATION,amanager, dmanager, pmanager FROM ISSUE I, PROJECT P, MODULES M WHERE ISSUEID='" + no + "' AND I.PID = P.PID AND MODULEID = MODULE_ID");//CORRECT
                        if (rs != null) {
                            while (rs.next()) {
                                ...
                                pmanager = rs.getString("pmanager");
                                dmanager = rs.getString("dmanager");
                                amanager = rs.getString("amanager");
                        ...
                        if (flag == true) {
                            if (!url.equals("continental-corporation.com")) {
                                ...
                                if (rs_comments != null) {
                                    ...
                                    rs_comments.next();
                    %>
                    <div class="subdivContainer component">
