        ...
        <FORM METHOD=POST ACTION="Updateform2.jsp"><%@ page
                ...
                <div align="center">
                    <center>
                        ...
                        <%
                            Connection c = null;
                            Statement stmt = null, stmt1 = null, stmt3 = null, stmt4 = null, state = null, state1 = null;
                            PreparedStatement ps = null, pt2 = null;
                            ResultSet rs = null, rs3 = null, result = null, result1 = null, rs4 = null;
                            String phase = null;
                            ...
                            try {
                                ...
                                rs = stmt.executeQuery("SELECT CUSTOMER, PNAME AS PROJECT, PLATFORM, MODULE, found_version, SEVERITY, PRIORITY, TYPE, VERSION AS FIX_VERSION, due_date FROM ISSUE I, PROJECT P, MODULES M WHERE I.PID = P.PID AND ISSUEID='" + no + "' AND I.PID = M.PID AND MODULEID = MODULE_ID");//CORRECT
                                if (rs != null) {
                                    while (rs.next()) {
                                                        ...
                                                        if (rs4 != null) {
                                                            while (rs4.next()) {
                                                                ...
                                                                if (url.equals("eminentlabs.net")) {
                                                                    count = IssueDetails.eTrackerIssueSearchCount(sub, no);
                                                                }
                                                                ...
                                                                ResultSet rs5 = stmt5.executeQuery("SELECT distinct category from project where pname = '" + pro + "'");//CORRECT
                                                                if (rs5 != null) {
                                                                    if (rs5.next()) {
                                                                ...
                                                                if (category.equalsIgnoreCase("SAP Project")) {
                                                                    ...
                                                                    ResultSet rs6 = stmt6.executeQuery("SELECT type from project_type,project where project.pid=project_type.pid and project.pname='" + pro + "' and category='" + category + "'");//CORRECT
                                                                    if (rs6 != null) {
                                                                        if (rs6.next()) {
                                                                    ...
                                                                    ResultSet rs7 = stmt7.executeQuery("SELECT phase,subphase,subsubphase,subsubsubphase from " + tablename + " where issueid='" + no + "'");//CORRECT
                                                                    if (rs7 != null) {
                                                                        if (rs7.next()) {
                                        ...
                                        <%
                                            ...
                                            if (rs3 != null) {
                                                if (rs3.next()) {
                                                    cnt++;
                                        %>
                                <td width="25%" id="filesIssue"><A
                                        onclick="viewFileAttachForIssue('<%=no%>');" href="#">ViewFiles</A></td>
                                        <%                                                                          }
                                            }
                                            if (rs3 != null) {
                                                rs3.close();
                                            ...
                                            if (cnt == 1) {
                                        %>
                                <td width="25%" id="filesIssue"><font
                        ...
                        <table width="100%" bgcolor="E8EEF7">
                            <tr>
                                ...
                                <td><input type="hidden" name="sub" id="sub"
                                           value="<%=sub%>" /></td>
            ...
            <div class="refissuepopupa chartarea" style="display: none;">
                ...
                <div>
                    <div class="clear"></div>
                    <div class="tableshow">
                        <div class="mid" id="IssuePopupFiles">
                        ...
                        <button class="custom-popup-close" onclick="closeIssuePopup();" type="button">close</button>
												...
												<div id="MDApopup" class="popup" style="height: 200px;">
                                                                        ...
                                                                        <h3 class="popupHeadingaa">New feature for upload file(s)<br/>
                                                                        </h3>
                                                                        <div style="margin: 10px;">
                                                                            <img src="<%=request.getContextPath()%>/images/file_notify.png"/>
                                                                        </div>
                                                                        <button  onclick="closeFilesPopup();" type="button" class="classname" style="float: right;">Get it</button>
                                                                    </div>
