...
<%
    ...
    Logger logger = Logger.getLogger("Member Edit");
...
<html>
    ...
    <script>
        ...
        {
            var pattern = "abcdefghijklmnopqrstuvwxyz.-_ ABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789";
            var i = 0;
            do
            {
                var pos = 0;
...
<body>
    ...
    <FORM name=theForm onsubmit="return fun(this)" action="<%=request.getContextPath()%>/contact/memberUpdate.jsp" method=post onReset="return setFocus()">
        ...
        <table width="100%" bgColor=#E8EEF7  align="center">
            <TBODY>
                ...
                <tr>
                    ...
                    <td width="23%"><input type="text" name="personalemail" id="personalemail" maxlength="60" size=25
                ...
                <tr bgcolor="C3D9FF">
                    ...
                    <td><input type="hidden" name="contactid" id="contactid" value="<%=contactid%>"></td>
                    <td><input type="hidden" name="contactowner" id="contactowner" value="<%=contactOwner%>"></td>
                </tr>
                ...
                <tr>
                    ...
                    <td width="21%"><input type="text" id="fax" name="fax" maxlength="30" size=14
                                           value="<%=fax%>"><strong class="style20"></strong></td>
                    <td width="10%"><strong>Home Phone</strong></td>
                    <td width="23%"><input type="text" id="homephone" name="homephone" maxlength="30" size=25
                                           value="<%=homephone%>"><strong class="style20"></strong></td>
                    <td width="12%"><strong>Other Phone</strong></td>
                    <td width="23%"><input type="text" id="otherphone" name="otherphone" maxlength="30" size=20
                ...
                <tr align="center">
                    <td></td><td></td><td></td>
                    <td  align="center"><INPUT type=submit value=Update id="submit"
                                               name=submit>
        ...
        %> 
        <iframe	src="<%=request.getContextPath()%>/admin/customer/comments.jsp?contactId=<%= contactid%>" scrolling="auto"
