<%-- 
    ...
    Created on : Sep 7, 2013, 6:02:28 PM
    Author     : Tamilvelan
--%>
<%@ page language="java" contentType="text/html"
	pageEncoding="UTF-8"%>
<%@ page import="org.apache.log4j.*,pack.eminent.encryption.*,java.util.HashMap"%>
...
<!--<table width="100%" align=center border="0" >
	<tr>
		<td>
                    ...
                    <a href="viewCandidate.jsp"><b>View Unscreended Candidates</b></a> &nbsp;&nbsp;&nbsp;&nbsp;
...
<table width=100%>
	<TR bgColor="#C3D9FF" height="9">
		...
		<TD width="7%"><font><b>Resume</b></font></TD>
                <TD width="7%"><font><b>Status</b></font></TD>
	</TR>
					...
					if(rs.next())
					{
						...
						if (area==null)
							area="nil";
                                                ...
                                                int status      =   rs.getInt("APPLICANT_STATUS");
