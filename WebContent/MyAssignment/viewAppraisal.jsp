	...
	<tr  bgcolor="#E8EEF7">
        ...
        <table cellpadding="0" cellspacing="0" width="100%">
            <tr style="height: 30px;">
                    <td align="left">This list shows <%=noOfRequest%> Appraisal Request assigned to you. </td>
            </tr>
        ...
        <table width="100%">
            ...
            %>
            <tr bgcolor="<%=color%>">
                    <td><a href="editAppraisal.jsp?appId=<%=appraisalrequest.getAppraisalId()%>"><%=GetProjectManager.getUserName(appraisalrequest.getAppraisalUser())%></a></td>
