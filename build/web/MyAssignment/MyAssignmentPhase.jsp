...
//                    }
                ...
                if (document.getElementById('issuestatus').value === 'Closed') {
                    ...
                    if (check === 'Select') {
                        alert('Your rating is valuable for us');
                                                                            ...
                                                                            if (userin == "MySearches") {
                                                                                ...
                                                                                if (team === 'BASIS') {
                                                                                    ...
                                                                                    $.ajax({url: '<%=request.getContextPath()%>/admin/project/checkMonitoringIssue.jsp',
                                                                                        data: {issueid: prev, random: Math.random(1, 10)},
                                                                                        async: true,
                                                                                        type: 'GET',
                                                                                        success: function (data) {
                                                                                            ...
                                                                                            if (result === '0') {
                                                                                                var text = "<%=request.getContextPath()%>/MyAssignment/UpdateIssueview.jsp?issueid=" + prev + "&sorton=" + "<%=sorton%>" + "&sort_method=" + "<%=sort_method%>" + "&userin=" + userin + "&planSeq=yes&project=" + "<%=product%>" + "&version=" + "<%=fixversion%>" + "&priority=" + "<%=pri%>" + "&status=" + "<%=issuestatus%>" + "&uid=" +<%=uid%>;
                                                                                                window.location = text;
                                                                                            } else {
                                                                                                var resulta = result.split('-');
                                                                                                var text = '<%=request.getContextPath()%>/admin/project/updateParameter.jsp?pid=' + resulta[0] + '&companyCode=' + resulta[1];
                                                                                                window.location = text;
                                                                                            }
                                                                                        }
                                                                                    });
                                                                        ...
                                                                        $('#next').click(function () {
                                                                            ...
                                                                            if (userin == "MySearches") {
                                                                                ...
                                                                                if (team === 'BASIS') {
                                                                                    var result;
                                                                                    $.ajax({url: '<%=request.getContextPath()%>/admin/project/checkMonitoringIssue.jsp',
                                                                                        data: {issueid: next, random: Math.random(1, 10)},
                                                                                        async: true,
                                                                                        type: 'GET',
                                                                                        success: function (data) {
                                                                                            result = $.trim(data);
                                                                                            ...
                                                                                            if (result === '0') {
                                                                                                var text = "<%=request.getContextPath()%>/MyAssignment/UpdateIssueview.jsp?issueid=" + next + "&sorton=" + "<%=sorton%>" + "&sort_method=" + "<%=sort_method%>" + "&userin=" + userin + "&planSeq=yes&project=" + "<%=product%>" + "&version=" + "<%=fixversion%>" + "&priority=" + "<%=pri%>" + "&status=" + "<%=issuestatus%>" + "&uid=" +<%=uid%>;
                                                                                                window.location = text;
                                                                                            } else {
                                                                                                var resulta = result.split('-');
                                                                                                var text = '<%=request.getContextPath()%>/admin/project/updateParameter.jsp?pid=' + resulta[0] + '&companyCode=' + resulta[1];
