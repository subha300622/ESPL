...
<body class="home-bg">
    ...
    <form name="theForma"  method="post" action="./userplannedIssuesReport.jsp" onsubmit="return update();">
...
//            });
    ...
    function update() {
    var plannedFor = $.trim($('#momdate').val());
    if (confirm("You are resquencing or unplanning for " + plannedFor + " planning!")) {
