...
<body>
    ...
    %>
    <h3><font color="blue">eTracker&#0153; 3.0_26 Sprint To Be Released on 20 Dec 2023</font></h3>
    <UL>
        <font size="5">
            <li>E09122023001 - Enable new link and display the main issue and sub issue as per BPM tree flow wise</li>
            <li>E24102023007 - Day wise E-Invoice report </li>
        </font>
    </UL>
    <h3><font color="#04B404">eTracker&#0153; 3.0_25 Sprint Released on 13 Dec 2023</font></h3>
    <UL>
        <font size="5">
            <li>E10042017008 - Sub issue linking to the main issue</li>
            <li>E31102023007 - When 3 branches is holiday the system will be consider as holiday other wise working day and system will do auto planning for next day</li>
        </font>
    </UL>
      <h3><font>eTracker&#0153; 3.0_24 Sprint Released on 22 Nov 2023</font></h3>
    <UL>
        <font size="5">
    ...
    <h3><font>eTracker&#0153; 2.9.5_47 Sprint To be Released on 20 Aug 10</font></h3>
    <UL>
        <font size="5">
    ...
    <h3><font>eTracker&#0153; 2.9.5_46 Sprint Released on 14 Aug 10</font></h3>
    <UL>
        <font size="5">
    ...
    <UL>
        <font size="5">
            <li>E09122023001 - Enable new link and display main issue and sub issue as per BPM tree flow wise</li>
            <li>E24102023007 - Day wise E-Invoice report </li>
        </font>
    </UL>
    <h3><font color="#04B404">eTracker&#0153; 3.0_25 Sprint Released on 13 Dec 2023</font></h3>
    ...
    <UL>
        <font size="5">
            <li>E28092023014 - Enabled asset link for 2 User IDs</li>
            <li>E28092023001 - Feedback comment adding mandatory for all rating </li>
            <li>Enabled demo links</li>
        </font>
    </UL>
