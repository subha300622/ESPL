                    ...
                    <td width="10%"><font face="Verdana, Arial, Helvetica, sans-serif" size="1" color="#000000"><%= rs1.getString("priority")%></font></td>
                        <%
                          ...
                          if (rating == null) {
                            ...
                            if (rs1.getString("status").equalsIgnoreCase("Closed")) {
                                if (rs1.getString("rating") != null) {
                                    if (rating.equalsIgnoreCase("Excellent")) {
                                        color = "#336600";
                        ...
                        %>
                    <td width="10%" bgcolor="<%=color%>"><font face="Verdana, Arial, Helvetica, sans-serif" size="1" color="#000000"><%=rating%></font></td>
