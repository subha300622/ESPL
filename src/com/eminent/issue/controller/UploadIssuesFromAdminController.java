 ...
 * @author Muthu
 */
public class UploadIssuesFromAdminController {
                ...
                if (fileItem != null) {
                    ...
                    if (fileItem.getSize() > 0 & fileItem.getSize() < 6291460) {
                        ...
                        if (ext.equalsIgnoreCase("xls")) {
                            status = issueDAO.readIssuesFromExcelByAdmin(is, userid_curr);
                        } else if (ext.equalsIgnoreCase("xlsx")) {
                            status = issueDAO.readIssuesFromXlsxByAdmin(is, userid_curr);
                        }
                    }
                }
