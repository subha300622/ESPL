 ...
 * @author Tamilvelan
 */
public class UploadSubprocess {
    public static void main(String[] args){
        String fileName =   "D:\\BPM\\5. Sub Process.xls";
	...
	Statement statement=null;
        ...
        createClient = connection.prepareStatement("insert into BPM_SUB_PROCESS(SP_ID,SUB_PROCESS,MP_ID,MAIN_PROCESS,BP_ID,BP_NAME,COMPANY_ID,COMPANY_NAME,CLIENT_ID,CLIENT_NAME) values(?,?,?,?,?,?,?,?,?,?)",ResultSet.TYPE_SCROLL_SENSITIVE,ResultSet.CONCUR_UPDATABLE);
