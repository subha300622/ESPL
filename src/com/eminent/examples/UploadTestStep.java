 ...
 * @author Tamilvelan
 */
public class UploadTestStep {
    public static void main(String[] args){
        String fileName =   "D:\\BPM\\8.Testcase.xls";
	...
	Statement statement=null;
        ...
        resultset=statement.executeQuery("select BPM_CLIENT_ID_SEQ.nextval as nextvalue from dual");
        createClient = connection.prepareStatement("insert into BPM_MAIN_PROCESS(MP_ID,MAIN_PROCESS,BP_ID,BP_NAME,COMPANY_ID,COMPANY_NAME,CLIENT_ID,CLIENT_NAME) values(?,?,?,?,?,?,?,?)",ResultSet.TYPE_SCROLL_SENSITIVE,ResultSet.CONCUR_UPDATABLE);
