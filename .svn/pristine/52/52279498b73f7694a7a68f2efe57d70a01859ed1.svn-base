    ...
    <%
        ...
        try {
            ...
            if (connection != null) {
                ...
                ps = connection.prepareStatement("SELECT contactid,FIRSTNAME,LASTNAME,ACCOUNTNAME,TITLE,PHONE,MOBILE,EMAIL,CREATEDON,DUEDATE,ASSIGNEDTO,CONTACT_OWNER,MODIFIEDON,RATING,COMPANY,DESCRIPTION,contact_type from CONTACT where roleid=2 and assignedto=? order by duedate ASC", ResultSet.TYPE_SCROLL_SENSITIVE, ResultSet.CONCUR_UPDATABLE);
    ...
    <table width=100% id="user" class="tablesorter">
        <thead>
            ...
            <tr bgColor="#C3D9FF" height="9">
                <th width="20%"><font><b>Contact Name</b></font></th>
            ...
            <tr height="22">
                ...
                <td width="20%" TITLE="<%= title%>"><A
                        HREF="<%=request.getContextPath()%>/MyCRM/contactIssueView.jsp?contactid=<%=contactid%>"><font
                            face="Verdana, Arial, Helvetica, sans-serif" size="1" color="#000000"><%=fullname%> </font></A>
                ...
                <td width="18%" TITLE="Description:<%= description%>,Last Comment:<%=lastcomment%>"><font face="Verdana, Arial, Helvetica, sans-serif"
