<%-- 
    Document   : addPlan
    Created on : Jan 26, 2012, 11:02:48 AM
    Author     : Tamilvelan
--%>
...
<%
    ...
    String issueDetails[][] = IssueDetails.displayIssues(userId, startDate, endDate, "Open");
%>
<html>
        ...
        <table cellpadding="0" cellspacing="0" width="100%">
            <tr bgcolor="#E8EEF7">
                <td bgcolor="#E8EEF7" border="1" align="left">
                    <font size="4" COLOR="#0000FF"> <b> Plan for Next Period </b></font>
                </td>
            ...
            <table border="0" width="100%">
                ...
                <tr>
                    <td colspan="11" align="center">
                        ...
                        <input type="button" id="userAction" name="userAction" value="Submit Next Cycle Plan" onclick="ValidateForm(document.forms['accIssues'], 'accIssue')">
                    </td>
                </tr>
            </table>
        </form>
