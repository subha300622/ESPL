<%-- 
    Document   : ClosedIssues
    Created on : Oct 31, 2009, 8:16:37 PM
...
<%
	...
	Logger logger = Logger.getLogger("Closed Issues");
...
<script>
    function monthSelection(){
        ...
        if(selectedValue>=startRange &&selectedValue<=current_date ){
            location = 'ClosedIssues.jsp?month='+month+'&year='+year;
        }else{
            alert("You can view your Closed Issues from Aug 2008 to Current Month");
        }
    }
...
<%
	...
	try
	{
		...
		if(hm==null)
		{
			hm	= GetProjectMembers.showUsers();
		}
...
//        logger.info("Selected Month"+selectMonth);
 ...
 //       logger.info("MAX DAY of MOnth"+maxday);
        ...
        String issueDetails[][]     =   IssueDetails.displayIssues(Integer.parseInt(workeduserid), start, end, "Closed");
...
%>
                    ...
                    <input type="button" value="Submit" onclick="monthSelection()"></td>
...
<table width="100%">
	<tr height="10">
            <td align="left" width="100%">The <b>Time Taken</b> for each closed issue in the month of <b><%=monthSelect.get(month)%> <%=year%></b> is listed below. Total closed issues are <b> <%=rowcount%>.
		</b></td>
...
<table width="100%" height="23">
	<TR bgcolor="#C3D9FF">
		...
		<TD width="27%"><font><b>Subject</b></font></TD>
		<TD width="9%"><font><b>Status</b></font></TD>
		<TD width="8%"><font><b>Due Date</b></font></TD>
		<TD width="9%"><font><b>CreatedBy</b></font></TD>
		<TD width="7%"><font><b>Refer</b></font></TD>
                <TD width="5%"><font><b>Rating</b></font></TD>
...
%>
		...
		<%
                                                            ...
                                                            %>
		<td width="9%"  title="Assigned To <%= (String)hm.get(current) %>"
><font
...
>ViewFiles(<%=fileCount%>)</A></font></td>
		...
		<td width="7%"><font face="Verdana, Arial, Helvetica, sans-serif"
			size="1" color="#000000">No Files</font></td>
                ...
                %>
                <td bgcolor="<%=color%>" title="<%=feedback%>"><font face="Verdana, Arial, Helvetica, sans-serif" size="1" color="#000000"><%=rating%></font></td>
