...
<%
    ...
    Logger logger = Logger.getLogger("UpdateIssueDetails");
...
<HTML>
    ...
    <BODY>
        <%
            ...
            System.out.print("iam in UpdateissueDetails of issueSummary678");
                                        ...
                                        <center><br>
                                            <table cellpadding="0" cellspacing="0" width="100%">
                                                <tr border="2" bgcolor="#F5F5F5">
                                                    <td bgcolor="#F5F5F5" border="1" align="left" width="70%"><font
                                                            size="4" COLOR="#0000FF"><b>My Assignments </b></font><FONT SIZE="3"
                                                    ...
                                                    <td colspan="3" align="CENTER" height="21"><font face="Tahoma"
                                                                                                     size="3" color="#00FF00"><%= "Updated Successfully"%></font></td>
                                                </tr>
                                            </table>
                                            <%
                                            ...
                                            <table align=left width="100%" bgcolor="EEEEEE">
                                                <tr>
                                            ...
                                            <table width="100%" bgcolor="EEEEEE">
                                                ...
                                                %>
                                                <tr>
                                                    <td height="21" width="15%"><B>Customer </B></td>
                                                    <td height="21" width="3%"><B>:</B></td>
                                                    <td height="21" width="25%" align="left" color="#bbbbbb"><%= cus%></td>
                                                    <td height="21" width="15%"><B>Product </B></td>
                                                    <td height="21" width="3%"><B>:</B></td>
                                                    <td height="21" width="25%"><%= pro%></td>
                                                    <td height="21" width="15%"><B>FoundVersion </B></td>
                                                    <td height="21" width="3%"><B>:</B></td>
                                                    <td height="21" width="25%"><%= ver%></td>
                                                </tr>
                                                <tr>
                                                    <td height="21" width="15%"><B>type </B></td>
                                                    <td height="21" width="3%"><B>:</B></td>
                                                    <td height="21" width="25%"><%= typ%></td>
                                                    <td height="21" width="15%"><B>Module </B></td>
                                                    <td height="21" width="3%"><B>:</B></td>
                                                    <td height="21" width="25%"><%= mod%></td>
                                                    <td height="21" width="15%"><B>Platform</B></td>
                                                    <td height="21" width="3%"><B>:</B></td>
                                                    <td height="21" width="25%"><%= pla%></td>
                                                </tr>
                                                <tr>
                                                    <td height="21" width="15%"><B>Severity </B></td>
                                                    <td height="21" width="3%"><B>:</B></td>
                                                    <td height="21" width="25%"><%=sev%></td>
                                                    <td height="21" width="15%"><B>Priority</B></td>
                                                    <td height="21" width="3%"><B>:</B></td>
                                                    <td height="21" width="25%"><%=pri%></td>
                                                    <td height="21" width="10%"><B>IssueStatus</B></td>
                                                            <%
...
%>
                                                ...
                                                <tr>
                                                    <td height="21" width="15%"><B>DateCreated </B></td>
                                                    <td height="21" width="3%"><B>:</B></td>
                                                    <td height="21" width="25%"><%= dateString%></td>
                                                    <td height="21" width="15%"><B>DateModified </B></td>
                                                    <td height="21" width="3%"><B>:</B></td>
                                                    <td height="21" width="25%"><%= dateString1%></td>
                                                    <td height="21" width="15%"><B>CreatedBy </B></td>
                                                    <td height="21" width="3%"><B>:</B></td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td height="21" width="15%" colspan="2"><B>
                                                            Files Attached </B></td>
                                                    ...
                                                    %>
                                                    <td width="8%" height="10" bgcolor="#EEEEEE" id="filesIssue"
                                                        ><A
                                                    ...
                                                    <td height="21" width="15%"><B>Fix Version</B></td>
                                                    <td height="21" width="3%"><B>:</B></td>
                                                    <td height="21" width="25%"><%= fix%></td>
                                                </tr>
                                            </table>
                                            ...
                                            <table width="100%" bgcolor="EEEEEE">
                                                ...
                                                <tr>
                                                    ...
                                                    <td><input type=hidden name="subject" value="<%=sub%>" /></td>
                                                    ...
                                                    <td><input type="hidden" name="des"
                                                               value="<%=StringUtil.encodeHtmlTag(des)%>" /></td>
                                                    <td><input type="hidden" name="com1"
                                                               value="<%=StringUtil.encodeHtmlTag(com1)%>" /></td>
                                                    <td><input type="hidden" name="issu" id="issueId" value="<%=theissu%>" /></td>
