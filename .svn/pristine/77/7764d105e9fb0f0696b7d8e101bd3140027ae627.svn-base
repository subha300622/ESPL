...
<table cellpadding="0" cellspacing="0" width="100%" bgColor="#C3D9FF">
	<tr>
		<td align="left"><font size="4" COLOR="#0000FF"><b>Disabled Lead
		</b> </font>
...
<% 
	session.setAttribute("forwardpage","disabledLead.jsp");
...
<!--                <a href="<%=request.getContextPath() %>/admin/customer/addnewlead.jsp">Add Lead</a>&nbsp;&nbsp;&nbsp;&nbsp; -->
                    ...
                    <b><a href="javascript:void(0)">Disabled Leads</a></b>
                </td>
...
%>
	<table align=right>
		<tr>
			<td>First</td>
			<td>Prev</td>
			<td><a href=disabledLead.jsp?manipulation=3>Next</a></td>
			<td><a href=disabledLead.jsp?manipulation=4>Last</a></td>
		</tr>
	</table>
	<%
			}
...
%>
	<table align=right>
		<tr>
			<td><a href=disabledLead.jsp?manipulation=1>First</a></td>
			<td><a href=disabledLead.jsp?manipulation=2>Prev</a></td>
			<td>Next</td>
			<td>Last</td>
		</tr>
	</table>
