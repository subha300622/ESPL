...
<%
	...
	Logger logger = Logger.getLogger("Viewleadrating");
...
<%
     ...
     // Checking whether the user has entered the name to search for
     	...
     	session.setAttribute("forwardpage","viewleadrating.jsp");
...
<% 
	...
	try
    {
		...
		if(connection != null)  
		{
            ...
            pt =  connection.prepareStatement("SELECT LEADID,TITLE,FIRSTNAME, LASTNAME, COMPANY, STATE,PHONE,MOBILE,EMAIL,LEADSTATUS,RATING,DUEDATE,ASSIGNEDTO,CREATEDON,MODIFIEDON,LEAD_OWNER from lead where roleid=2 and upper(rating)=? and upper(leadstatus)=? order by UPPER(FIRSTNAME) ASC ",ResultSet.TYPE_SCROLL_SENSITIVE, ResultSet.CONCUR_UPDATABLE);
            pt.setString(1,rating.toUpperCase());
            pt.setString(2,status.toUpperCase());
            rs=pt.executeQuery();
            rs.last();
...
<br>
<form name="showusers" action="approveLeads.jsp" onSubmit="return ValidateForm(this,'approve')">
<table width=100%>
...
<tr>
	<td>First</td>
	<td>Prev</td>
	<td><a href=viewleadrating.jsp?manipulation=3>Next</a></td>
	<td><a href=viewleadrating.jsp?manipulation=4>Last</a></td>
</tr>
</table>
<%
	}
...
<table align=right>
<tr>
	<td><a href=viewleadrating.jsp?manipulation=1>First</a></td>
	<td><a href=viewleadrating.jsp?manipulation=2>Prev</a></td>
	<td>Next</td>
	<td>Last</td>
</tr>
</table>
