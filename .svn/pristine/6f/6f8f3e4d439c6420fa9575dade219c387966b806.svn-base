...
//	  			String mail = (String)application.getAttribute("MailServerName");
	  			 ...
	  			 ArrayList<String> al       = dashboard.Project.getDetails("CRM"+":"+"1.0");
	  				...
	  				subject = "eTracker CRM Account has been Updated :  "  +accountname;
	...
	String link=pag;
            int assinmentNo = UserIssueCount.getAssignmentCount(userId);
            List tce = TestCasePlan.listUserExecution(user);
            ...
            String for_ward = CRMIssue.getHigestCRMIssues(connection, user, user);
