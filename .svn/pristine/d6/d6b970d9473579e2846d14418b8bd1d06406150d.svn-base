...
var WeekDayColor="#CCFFFF";//Background color of weekdays.
var FontColor="blue";//color of font in Calendar day cell.
var TodayColor="#00CC99";//Background color of today.
var SelDateColor="WHITE";//Backgrond color of selected date in textbox.
var YrSelColor="#cc0033";//color of font of Year selector.
var MthSelColor="#cc0033";//color of font of Month selector if "MonthSelector" is "arrow".
//var ThemeBg="http://localhost/eTracker/images/planitia.jpg";//Background image of Calendar window.
...
function RenderCal()
{
	...
	if (Cal.Scroller=="DROPDOWN")
	{
		...
		for (i = 1965; i < (fromDate.getFullYear() -15);i++)
		{
			if (i==Cal.Year)
				SelectStr="Selected";
			else
