<%-- 
    Document   : viewScreening
    Created on : Apr 9, 2012, 7:53:52 PM
    Author     : Tamilvelan
--%>
...
<%
    ...
    Logger logger = Logger.getLogger("viewScreening");
...
<body>
    ...
    <% String filePath = request.getSession().getServletContext().getInitParameter("upload-resume");
        ...
        session.setAttribute("forwardpage", "/admin/candidate/viewScreening.jsp");
    ...
    <table width="100%" align=center border="0" >
        <tr>
            <td>
                ...
                <a href="viewScreening.jsp"><b>View Screening Candidates</b></a>   &nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <TABLE width="100%" border="0">
        <tr>
            ...
            %>
            <td>Displaying&nbsp;<%=issuenofrom%>&nbsp;- <%=issuenoto%>&nbsp;of&nbsp;<b><%=rowcount%></b> screening candidates .</td>
            <%
                }
            %>
        </tr>
    ...
    <table width=100%>
        ...
        <table align=right>
            <tr>
                <td>First</td>
                <td>Prev</td>
                <td><a href=viewScreening.jsp?manipulation=3>Next</a></td>
                <td><a href=viewScreening.jsp?manipulation=4>Last</a></td>
            </tr>
        </table>
        <%
        ...
        <table align=right>
            <tr>
                <td><a href=viewScreening.jsp?manipulation=1>First</a></td>
                <td><a href=viewScreening.jsp?manipulation=2>Prev</a></td>
                <td>Next</td>
                <td>Last</td>
            </tr>
        </table>
