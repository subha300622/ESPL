   ...
   //                         cell3.appendChild(link);
     ...
     //                        alert('Deleting Row'+issueIdRow);
                ...
                function addIssue(){
                    ...
                    window.open("createTestIssues.jsp?project="+project+"&version="+version+"&module="+module+"&ptcid="+ptcid,"Ratting");
                }
                        ...
                        <table width="100%" id="testcases">
                            ...
                            <tr bgcolor="#E8EEF7">
                                ...
                                <%
                                    ...
                                    if(size>0){
%>
                                <td colspan="3"><a href="viewFiles.jsp?tceId=<%=tceId%>">View Files(<%=size%>)</a></td>
                                <%}else{%>
