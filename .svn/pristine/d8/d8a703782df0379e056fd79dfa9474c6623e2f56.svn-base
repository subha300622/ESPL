<%-- 
    ...
    Created on : Jan 26, 2012, 11:02:35 AM
    Author     : Tamilvelan
--%>
...
<%
    ...
    logger.info("Period in Activities-->" + period);
    ...
    String issueDetails[][] = IssueDetails.displayIssues(userId, startDate, endDate, "Worked Open");
%>
<html>
        ...
        <table cellpadding="0" cellspacing="0" width="100%">
            <tr bgcolor="#E8EEF7">
                <td bgcolor="#E8EEF7" border="1" align="left">
                    <font size="4" COLOR="#0000FF"> <b> On Going Activity Issues </b></font>
                </td>
              ...
              //                                  age = WorkedTime.getHoldingTime(iss, workeduserid,selectedStartDate,selectedEndDate);
                ...
                <tr>
                    <td colspan="11" align="center">
                        ...
                        <input type="button" id="userAction" name="userAction" value="Submit On Going Activities" onclick="ValidateForm(document.forms['accIssues'], 'accIssue')">
                    </td>
                </tr>
            </table>
        </form>
