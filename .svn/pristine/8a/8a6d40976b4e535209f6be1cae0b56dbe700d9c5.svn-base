<%-- 
    Document   : excelForSearchStatus
    Created on : Jul 21, 2008, 1:00:48 PM
...
<TABLE width="100%" border="0">
	<tr>
		<td colspan="3">Displaying&nbsp;<b><%= rowcount%></b> applicants
		with status : <b><%= Applicant.getApplicantStatus(status) %></b></td>
	</tr>
</TABLE>
<br>
