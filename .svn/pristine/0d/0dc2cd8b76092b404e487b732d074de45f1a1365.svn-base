...
<%@ page
    import="pack.eminent.encryption.*,com.eminent.util.*,dashboard.CheckDate"%>
                ...
                <table cellpadding="0" cellspacing="0" width="100%">
                    <tr border="2" bgcolor="C3D9FF">
                        ...
                        <%
                            ...
                            session.setAttribute("dashBoard", "ASAPIssues");
                            session.setAttribute("forwardpage", "/admin/dashboard/showIssues.jsp");
                            //int count =0;
                            try {
                                ...
                                if (connection != null) {
                                    ...
                                    if (request.getParameter("issuestatus") == null) {
                                        ...
                                        subPhase = request.getParameter("subphase");
                                        ...
                                        if (project == null) {
                                            ...
                                            project = (String) session.getAttribute("sapProject");
                                            projectType = (String) session.getAttribute("sapProjectType");
                                            phase = (String) session.getAttribute("sapPhase");
                                            subPhase = (String) session.getAttribute("sapSubPhase");
                                            priority = (String) session.getAttribute("sapPriority");

                                        }

                                        if (flag == false) {

                                            session.setAttribute("sapProject", project);
                                            session.setAttribute("sapProjectType", projectType);
                                            session.setAttribute("sapPhase", phase);
                                            session.setAttribute("sapSubPhase", subPhase);
                                            session.setAttribute("sapPriority", priority);
                                        }

                                        logger.info("Project" + project);
                                        logger.info("Project Type" + projectType);
                                        logger.info("Phase" + phase);
                                        logger.info("Sub Phase" + subPhase);
                ...
                <table width="100%">
                    <tr height="10">
                        <td align="left" width="100%">Displaying &nbsp;<b><%= rowcount%></b> &nbsp;Issues
                                with subphase <b><%= subPhase%></b> and priority <b><%= priority%></b></td>
...
int i = 1;
                            ...
                            %>
                                ...
                                %>
                                <td class="background"  width="10" TITLE="<%= type%>"><font
                                ...
                                <td class="background"  width="10%" TITLE="<%= type%>"><font
                                        ...
                                        %>
                                <td class="background"  width="7%" title="<%=fullModule%>"> <font face="Verdana, Arial, Helvetica, sans-serif" size="1" color="#000000"><%= module%></font></td>
                                <td class="background"  id="<%=iss%>tab" onmouseover="xstooltip_show('<%=iss%>', '<%=iss%>tab', 289, 49);" onmouseout="xstooltip_hide('<%=iss%>');" >
                                    <div class="issuetooltip" id="<%=iss%>"><%= desc%></div>
                                ...
                                <td class="background"  width="11%" onclick="showPrint('<%=iss%>');" style="cursor: pointer;"><font
                                ...
                                %>
                                <td class="background"  width="8%" title="Last Modified On <%= modifiedOn%>"><font
                                ...
                                %>
                                <td class="background" width="10%"><font
                                ...
                                <td class="background" ><font face="Verdana, Arial, Helvetica, sans-serif" size="1" color="#000000">No Files</font></td>
                                        ...
                                        %>
                                <td class="background" width="3%" align=center title="<%=lastAsigneeAge%>"><font
