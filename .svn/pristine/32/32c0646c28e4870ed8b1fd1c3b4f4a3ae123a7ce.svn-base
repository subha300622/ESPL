...
public class UploadCompany {
    public static void main(String[] args){
        String fileName =   "D:\\BPM\\2. Company.xls";
	...
	Statement statement=null;
        ...
        createClient = connection.prepareStatement("insert into BPM_COMPANY(COMPANY_ID,COMPANY_NAME,CLIENT_ID,CLIENT_NAME) values(?,?,?,?)",ResultSet.TYPE_SCROLL_SENSITIVE,ResultSet.CONCUR_UPDATABLE);
 ...
 //              if(j==1){
 //              createClient.setInt((j+2), Integer.parseInt(stringValue));
 //             }else{
