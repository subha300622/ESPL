...
public class UploadScenario {
    public static void main(String[] args){
        String fileName =   "D:\\BPM\\6. Scenario.xls";
	...
	Statement statement=null;
        ...
        createClient = connection.prepareStatement("insert into BPM_SCENARIO(SCENARIO_ID,SCENARIO,SP_ID,SUB_PROCESS,MP_ID,MAIN_PROCESS,BP_ID,BP_NAME,COMPANY_ID,COMPANY_NAME,CLIENT_ID,CLIENT_NAME) values(?,?,?,?,?,?,?,?,?,?,?,?)",ResultSet.TYPE_SCROLL_SENSITIVE,ResultSet.CONCUR_UPDATABLE);
