<%-- 
    Document   : createdIssueChart
    Created on : 14 Jun, 2010, 12:11:18 PM
    Author     : ADAL
--%>
...
<%
    ...
    Logger logger = Logger.getLogger("CreatedIssueChart");
...
//        logger.info("Selected Month"+selectMonth);
    ...
    //Retriving Open Issues for all projects
    String projectCreatedIssues[][] = ProjectIssues.totalCreatedIssues(startDate, endDate);
    Date endDateinD = sdf.parse(endDate);

    cal.setTime(endDateinD);
    cal.add(Calendar.MONTH, 1);
    int monthq1 = cal.get(Calendar.MONTH);
    int maxdaya = cal.get(Calendar.DAY_OF_MONTH);
    ...
    String projectCreatedIssuesa[][] = ProjectIssues.totalCreatedIssues(startDatea, endDatea);
    endDateinD = sdf.parse(endDatea);

    cal.setTime(endDateinD);
    cal.add(Calendar.MONTH, 1);
    int monthq2 = cal.get(Calendar.MONTH);
    int maxdayb = cal.get(Calendar.DAY_OF_MONTH);
    ...
    logger.info("Start Date  :" + startDate);
    logger.info("End Date    :" + endDate);
    String projectCreatedIssuesb[][] = ProjectIssues.totalCreatedIssues(startDateb, endDateb);
    ...
    int maxdayc = cal.get(Calendar.DAY_OF_MONTH);
    ...
    //Retriving Worked Issues for all projects
    String projectCreatedIssuesc[][] = ProjectIssues.totalCreatedIssues(startDatec, endDatec);
    endDateinD = sdf.parse(endDatec);

    int noOfProjects = projectCreatedIssues.length;
    int noOfProjectsa = projectCreatedIssuesa.length;
    int noOfProjectsb = projectCreatedIssuesb.length;
    int noOfProjectsc = projectCreatedIssuesc.length;
...
<html>
        ...
        <script type="text/javascript">
            function monthSelection() {
                ...
                if (selectedValue >= startRange && selectedValue <= current_date) {
                    ...
                    location = 'createdIssueChart.jsp?month=' + month + '&year=' + year;
                } else {
                    alert("You can view Eminentlabs Open Issues chart from Aug 2008 to Current Month");
                }
            }
    ...
    <body>
        ...
        <table width="100%" bgColor="#C3D9FF">
            <tr  bgColor="#C3D9FF">
                <td  align="left" width="55%"><font size="4" COLOR="#0000FF"><b>Created Isssue for the Month of</b></font>
...
//                                    "paletteColors": "#0075c2,#1aaf5d,#f2c500,#f45b00,#8e0000",
            ...
            %>
                                    {
                                        "label": "<%=projectCreatedIssues[k][1]%>",
                                                "value": "<%= projectCreatedIssues[k][2]%>",
                                                "link":'<%= request.getContextPath()%>/admin/user/eminentCreatedIssues.jsp?month=<%=month%>&year=<%=year%>&pid=<%=projectCreatedIssues[k][0]%>'
                                                                        },
            <% j++;
            }%>
                                                                        ]
...
//                                    "paletteColors": "#0075c2,#1aaf5d,#f2c500,#f45b00,#8e0000",
            ...
            %>
                                    {
                                        "label": "<%=projectCreatedIssuesa[k][1]%>",
                                                "value": "<%= projectCreatedIssuesa[k][2]%>",
                                                "link":'<%= request.getContextPath()%>/admin/user/eminentCreatedIssues.jsp?month=<%=month%>&year=<%=year%>&pid=<%=projectCreatedIssuesa[k][0]%>'
                                                                        },
            <% j++;
            }%>
                                                                        ]
...
//                                    "paletteColors": "#0075c2,#1aaf5d,#f2c500,#f45b00,#8e0000",
            ...
            %>
                                    {
                                        "label": "<%=projectCreatedIssuesb[k][1]%>",
                                                "value": "<%= projectCreatedIssuesb[k][2]%>",
                                                "link":'<%= request.getContextPath()%>/admin/user/eminentCreatedIssues.jsp?month=<%=month%>&year=<%=year%>&pid=<%=projectCreatedIssuesb[k][0]%>'
                                                                        },
            <% j++;
            }%>
                                                                        ]
...
//                                    "paletteColors": "#0075c2,#1aaf5d,#f2c500,#f45b00,#8e0000",
            ...
            %>
                                    {
                                        "label": "<%=projectCreatedIssuesc[k][1]%>",
                                                "value": "<%= projectCreatedIssuesc[k][2]%>",
                                                "link":'<%= request.getContextPath()%>/admin/user/eminentCreatedIssues.jsp?month=<%=month%>&year=<%=year%>&pid=<%=projectCreatedIssuesc[k][0]%>'
                                                                        },
            <% j++;
            }%>
                                                                        ]
        ...
        <div style="width: 100%;">
            ...
            <table width="100%">
                <tr>
                    <td width="100%">No Created Issue available</td>
                </tr>
            </table>
            <%    }
            %>
