...
<%
	...
	Logger logger = Logger.getLogger("deniedContacts");
...
<table cellpadding="0" cellspacing="0" width="100%" bgColor="#C3D9FF">
	<tr>
		<td align="left"><font size="4" COLOR="#0000FF"><b>Denied Contacts
		</b> </font>
...
<% 
	...
	try
    {
		session.setAttribute("forwardpage","deniedContacts.jsp");
...
<TABLE width="100%" border="0">
	<tr>
		<td>
                    ...
                    <b><a href="javascript:void(0)">Denied Contacts</a></b>&nbsp;&nbsp;&nbsp;&nbsp; 
...
%>
		<table width="100%" height="70%" align="center">
			<tr>
				...
				<h3 align="center"><%= "No denied contacts" %></h3>
				</font></td>
			</tr>
		</table>
		<%
...
%>
	<table align=right>
		<tr>
			<td>First</td>
			<td>Prev</td>
			<td><a href=deniedContacts.jsp?manipulation=3>Next</a></td>
			<td><a href=deniedContacts.jsp?manipulation=4>Last</a></td>
		</tr>
	</table>
	<%
			}
...
%>
	<table align=right>
		<tr>
			<td><a href=deniedContacts.jsp?manipulation=1>First</a></td>
			<td><a href=deniedContacts.jsp?manipulation=2>Prev</a></td>
			<td>Next</td>
			<td>Last</td>
		</tr>
	</table>
