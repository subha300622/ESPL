    ...
    <body>
        ...
        <%@ page
                ...
                try {
                    ...
                    if (connection != null) {
                        if (ip != null && machinename != null && user != null) {
                            ...
                            ps = connection.prepareStatement("update resources set ipaddress=?,machinename=?,assigneduser=?,cpudetails=?,ramdetails=?,harddisk=?,motherboard=?,OS=?,value=?,status=? where unique_asset_no=? ");
                            ...
                            ps.setString(9, StringUtil.fixSqlFieldValue(value));
                            ps.setString(10, StringUtil.fixSqlFieldValue(status));
                            ps.setString(11, StringUtil.fixSqlFieldValue(uniqueno));
            ...
            <jsp:forward page="/admin/resource/viewResources.jsp">
                <jsp:param name="newresource" value="updated" />
