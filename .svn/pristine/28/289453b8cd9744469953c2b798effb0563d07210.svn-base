...
<html>
    ...
    <body>
        ...
        <FORM name="theForm" onsubmit="return fun(this)" method="post" onReset="return setFocus()"><!-- Table To Display Current User And The Links For User Profile, Mails, And Logout -->
            ...
            <TABLE width="35%" bgcolor="#E8EEF7" border="0" align="center">
                <%
                    ...
                    session.setAttribute("projectid", new Integer(pids));
                %>
                <TBODY>
                    <tr>
                        <td width="35%"><strong>Module Name </strong></td>
                        <td><input type="text" name="mname" maxlength="20" size="20"> <strong class="style20"></strong>
                        </td>
                        <td><input type="hidden" name="pid" id="pid" maxlength="20" size="20"
                                   value="<%=pids%>"> <strong class="style20"></strong></td>
                    </tr>
