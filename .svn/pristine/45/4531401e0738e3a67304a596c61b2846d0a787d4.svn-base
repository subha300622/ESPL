...
public class UploadClient {
    public static void main(String[] args){
        String fileName =   "D:\\BPM\\1.Client.xls";
	...
	Statement statement=null;
        ...
        createClient = connection.prepareStatement("insert into BPM_CLIENT(CLIENT_ID,CLIENT_NAME) values(?,?)",ResultSet.TYPE_SCROLL_SENSITIVE,ResultSet.CONCUR_UPDATABLE);
        for(int i=0;i<data.size();i++){
           ...
           createClient.setString(2, stringValue);
