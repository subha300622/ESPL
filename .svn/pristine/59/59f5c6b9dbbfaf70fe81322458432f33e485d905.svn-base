...
<html>
    <meta name="keywords" content="GST in SAP, SAP GST Accelerator, GST Success in SAP, GST India in SAP, GST SAP Success, GST Suvidha Provider, GST ASP GSP, GST, CGST,SGST, IGST, UGST,  SAP NW based Product Development, SAP Consulting, SAP Implementation, SAP Support Services, SAP Outsourcing, SAP Implementation India, SAP Implementation Bangalore, SAP Implementation Chennai, SAP Implementation Belgium, SAP Implementation Paris, SAP Implemtation Australia, SAP Implementation France, SAP Implementation Mumbai, SAP Implementation Kerala, SAP Implementation Belgaum, SAP Implementation Thailand, SAP Implementation Mexico, SAP Implementation America">
        ...
        <script type="text/javascript">
            ...
            $(document).ready(function ()
            {
                ...
                $("#showAccomplishment").click(function ()
                {
                    if ($("#showAccomplishment").hasClass('expand')) {
                        ...
                        $("#showAccomplishment").html("<img src='<%= request.getContextPath()%>/images/ajax-loader.gif'>")
                        var appId = document.getElementById('appId').value;
                        $.ajax({
                ...
                $("#showActivities").click(function ()
                {
                    if ($("#showActivities").hasClass('expand')) {
                        ...
                        $("#goingDiv").html("<img src='<%= request.getContextPath()%>/images/ajax-loader.gif'>");
                        var appId = document.getElementById('appId').value;
                        $.ajax({
                ...
                $("#showPlan").click(function ()
                {
                    if ($("#showPlan").hasClass('expand')) {
                        ...
                        $("#planDiv").html("<img src='<%= request.getContextPath()%>/images/ajax-loader.gif'>")
                        var appId = document.getElementById('appId').value;
                        $.ajax({
                ...
                $("#showTimeAcc").click(function ()
                {
                    if ($("#showTimeAcc").hasClass('expand')) {
                        ...
                        $("#timesheetAcc").html("<img src='<%= request.getContextPath()%>/images/ajax-loader.gif'>")
                ...
                $("#showTimePlan").click(function ()
                {
                    if ($("#showTimePlan").hasClass('expand')) {
                        ...
                        $("#timesheetPlan").html("<img src='<%= request.getContextPath()%>/images/ajax-loader.gif'>")
                        var appUser = document.getElementById('appUser').value;
                        $.ajax({
                ...
                $("#showTimeLearning").click(function ()
                {
                    if ($("#showTimeLearning").hasClass('expand')) {
                        ...
                        $("#timesheetLearnings").html("<img src='<%= request.getContextPath()%>/images/ajax-loader.gif'>")
                        var appUser = document.getElementById('appUser').value;
                        $.ajax({
                ...
                $("#showWorked").click(function ()
                {
                    if ($("#showWorked").hasClass('expand')) {
                        ...
                        $("#workedIssues").html("<img src='<%= request.getContextPath()%>/images/ajax-loader.gif'>")
                        var appUser = document.getElementById('appUser').value;
                        $.ajax({
            ...
            function fun(theForm)
            {
                ...
                if (validate == 'yes') {
                    if (trim(CKEDITOR.instances.comments.getData()).length <= 0 || trim(CKEDITOR.instances.comments.getData()) == "")
                    {
                ...
                if (validate == 'submission') {
                  ...
                  if (status == '7') {
                    ...
                    if (userApp === '') {
                        ...
                        document.getElementById('userAppraisal').focus();
                        return false;
                    }
                }
                if (validate == 'review') {
    ...
    <body>
        ...
        <form name="theForm" action="updateAppraisal.jsp" onsubmit="return fun(this);">
            <table width="100%" bgcolor="#E8EEF7" id="appTable">
                ...
                <tr style="height:30px;">
                    ...
                    <td>
                        ...
                        %>
                        <input type="hidden" name="status" id="status" value="<%=statusId%>"/>
                        <%
                            }%>
                ...
                <tr style="height:30px;">
                    ...
                    <td>
                        ...
                        <input type="hidden" name="secondAppraiser" id="secondAppraiser" value="<%=secondAppraiser%>">
                        <%
                            }%>
                    ...
                    <td>
                        ...
                        <input type="hidden" name="thirdAppraiser" id="thirdAppraiser" value="<%=thirdAppraiser%>">
                        <%
                            }%>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td><%=userAppraisal%>
                        <input type="hidden" name="userAppraisal" id="userAppraisal" value="<%=userAppraisal%>">
                ...
                %>
                <tr bgcolor="#C3D9FF">
                    <td colspan="6" style="font-weight: bold;"> Accomplishments  &nbsp;<span id="showAccomplishment" style="cursor:pointer;font-weight: bold;"> <b>></b></span></td>
                </tr>
                <tr>
                ...
                %>
                <tr bgcolor="#C3D9FF">
                    <td colspan="6" style="font-weight: bold;"> On Going &nbsp;Activities  <span id="showActivities" style="cursor:pointer;font-weight: bold;"> <b>></b></span></td>
                </tr>
                <tr>
                ...
                %>
                <tr bgcolor="#C3D9FF">
                    <td colspan="6" style="font-weight: bold;">Next Cycle Plan &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;<span style="cursor:pointer;" id="showPlan">></span></td>
                </tr>
                ...
                <tr>
                    ...
                    <td colspan="4" align="center"><input type="button" id="showUserAccomplishment" value="Submit Accomplishment" ></td>
                </tr>
                <%
                ...
                <tr>
                    ...
                    <td colspan="6" align="center"><input type="submit" id="submit" value="Submit"></td>
                </tr>
